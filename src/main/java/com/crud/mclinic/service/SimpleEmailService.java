...
public class SimpleEmailService {
    ...
    private MimeMessagePreparator createMimeMessage(final Mail mail) {
        return mimeMessage -> {
            ...
            messageHelper.setText(mailCreatorService.buildBookVisitEmail(mail.getMessage()), true);
        };
    }
    ...
    private SimpleMailMessage createMailMessage(final Mail mail) {
        ...
        mailMessage.setText(mailCreatorService.buildBookVisitEmail(mail.getMessage()));
        return mailMessage;
    }
